...
A full end-to-end machine learning pipeline to predict Airbnb listing prices across Melbourne using property, host, location, review, and amenity data. The final submission used a stacking ensemble of seven models, achieving a Kaggle MAE of **~258** on the final leaderboard.
...
| Final (stacking + interaction features) | ~258 | **2nd** |
